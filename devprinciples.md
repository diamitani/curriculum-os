...
use tools like framer, figma, webflow, etc to find and extract design systems from premium websites. find the space the user is looking to build for and pull as many as you can. add them to your knowledge base. ask questions and interweave insights to produce something unique.

take from each of the top designers and creators, build a repository of best practices and knowledge that spans the entire web. from the top SaaS companies, best in class marketplaces, best in class creator platforms, best in class e-learning platforms, best in class directory platforms, best in class SaaS companies, best in class SaaS companies, etc.
...
- [ ] create a template reference index of best practices for hteproject so you can build beautiful designs.
